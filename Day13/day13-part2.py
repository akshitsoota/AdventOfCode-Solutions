...
def main():
    ...
    # I gotta add myself as well
    information["Me"] = {}
    for key in information:
        # Iterate over the information dictionary and start adding the values
        if key == "Me": continue  # Skip myself
        information[key]["Me"] = 0  # How the 'key' person would feel sitting next to me is zero diff in happiness
        information["Me"][key] = 0  # How I would feel sitting next to the 'key' person would make zero diff in happiness
